            ...
            <form action="registrationCheck.php" method="POST">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col">
                    <input type="text" class="form-control" id="mailAdress" name="mailAdress" placeholder="c011xxxxxx@xxxxxxxx.jp"
                    value="">
                ...
                <div class="form-group">
                  ...
                  <div class="col">
                    <input type="text" class="form-control" id="account" name="account" placeholder="アカウント名"
                    value="">
                ...
                <div class="form-group">
                  ...
                  <div class="col">
                    <input type="password" class="form-control" id="password" name="password" placeholder="半角英数字の5文字以上30文字以下"
                    value="">
                ...
                <div class="form-group">
                  ...
                  <div class="col">
                    <input type="password" class="form-control" id="password_conf" name="password_conf" placeholder="半角英数字の5文字以上30文字以下"
                    value="">
